...
function checkWinner() {
    if (pTally === 3 || cTally === 3) {
        const winner =
            pTally === 3 ? ((document.getElementById("modal-result").innerHTML =
                "Congratulations you win the Treasure"), (document.getElementById("modal-img").src =
                "assets/images/treasure-chest.JPEG")) : ((document.getElementById("modal-result").innerHTML =
                "Bad luck the treasure has been stolen"), (document.getElementById("modal-img").src =
